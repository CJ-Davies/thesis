...
\section{Overview}
\label{vtw-overview}
The Virtual Time Window (VTW) was a preliminary investigation into the application of parallel reality to virtual heritage, that leveraged the OVW group's existing OpenSim reconstructions of cultural heritage sites in a handheld package that allows tandem exploration of both the real cultural heritage sites and their spatially equivalent virtual reconstructions.
...
Appendix \ref{appendix-vtw-hardware} contains a hardware reference witht wiring diagrams and pinout values for connectivity of the MAX-6 to an Arduino Uno R3.
...
Table \ref{influence-factors-vtw-table} lists the principle factors observed throughout the evaluation of the VTW platform that were used to influence the subsequent creation of the Mirrorshades parallel reality platform (chapter \ref{chapter-mirrorshades}).
...
Position Control & Should be more accurate to fully realise scenarios 2 and 3, and must be substantially more accurate for an indoor application. \\
