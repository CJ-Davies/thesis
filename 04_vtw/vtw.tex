...
Included the AsyncSerial class from Terraneo Federico (licensed under the Boost Software License)

Wrote LLViewerSerialmovement which uses AsyncSerial to read the Arduino's messages

Instantiate LLViewerSerialmovement in LLAppViewer

Run LLViewerSerialmovement::update() in LLAppViewer::mainLoop()

Wrote LLFloaterSerialMonitor as GUI for configuring/activating/deactivating serial control
