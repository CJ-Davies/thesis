...
Table \ref{influence-factors-vtw-table} lists the principle factors raised throughout the experience of designing, developing and testing the VTW platform, which influenced the subsequent creation of the Mirrorshades parallel reality platform (chapter \ref{chapter-mirrorshades}).
