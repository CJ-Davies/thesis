...
%make table of contents clickable in the pdf
\usepackage{hyperref}
...
%because having footnotes in captions where the two actually appear on the same page is madness
\usepackage{afterpage}

%fancier headers/footers
\usepackage{fancyhdr}
...
%\chapter*{Collaborations and Publications}
%\input{collaborations.tex}
...
\chapter{VTW Hardware Reference}
\graphicspath{ {04_vtw/images/} }
\input{appendices/vtw-hardware.tex}
\label{appendix-vtw-hardware}

\chapter{\texttt{LLViewerSerialMovement} reference}
\input{appendices/vtw-software.tex}
\label{appendix-vtw-software}

\chapter{OpenSim Region Module GPS excerpt}
\input{appendices/region-module.tex}
\label{appendix-region-module}

\chapter{Second Life GPS excerpt}
\input{appendices/appendix-secondlife-haversine.tex}
\label{appendix-secondlife-haversine}

\chapter{Ethical Approval}
\includepdf[pages={1-2}]{appendices/ethics.pdf}
