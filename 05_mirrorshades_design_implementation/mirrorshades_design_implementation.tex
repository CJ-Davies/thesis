...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Visualisation using the combined Milgram/Waterworth model of the theorised experience of a user of a parallel reality system performing a transition between a RW/VR mix and the VR environment.}
