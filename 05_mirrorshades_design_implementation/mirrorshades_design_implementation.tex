...
The completed Mirrorshades platform was initially tested within the department building
...
Note that in this footage \& screencaps, the camera feeds are rendered to the full expanse of the DK1's display, something which would later be changed to match FOV correctly (see section \ref{modifying-dk1}).
