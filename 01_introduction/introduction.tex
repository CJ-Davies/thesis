...
The approach taken by this body of research was first to develop a well defined set of definitions for different categories of existing alternate reality, in order to correctly situate the new paradigm of parallel reality against them and to inform its design and implementation from the findings and adopted best practices produced by their investigation. This process, which is covered by chapter \ref{chapter-background}, involved effecting updates to several previously established models and the development of the combined Milgram/Waterworth model to sufficiently illustrate and understand the experiential aspect of the parallel reality paradigm.
...
Initially the Virtual Time Window platform, discussed in chapter \ref{chapter-vtw}, was developed in order to explore the potential suitability of an existing alternate reality modality of interaction to serve as a platform for investigation into parallel reality experience. After the experiential aspect of the Virtual Time Window did not fully meet with the vision of the parallel reality concept, the Mirrorshades platform, discussed in chapter \ref{chapter-mirrorshades}, was developed in order to fully realise the ideals of the paradigm via a new modality of alternate reality interaction.
...
Table \ref{objectives} provides an overview of the sections of the thesis in which each objective is addressed, along with relevant publications from section \ref{collaborations-and-publications}.
