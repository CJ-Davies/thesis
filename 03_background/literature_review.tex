...
\textbf{Also mention the concepts of `place' \& `non-place' that are prominent throughout PoSR literature?}
...
\textbf{***We haven't mentioned `simultaneous presence' at all(?), \& although we want to shy away from it I think it is worth at least mentioning in passing in the section about presence?}
