...
The term `parallel reality' is proposed to refer to systems such as that explored in this thesis, which combine complete real \& virtual environments together in a manner that allows mobile exploration of them both in tandem, relating it \& positioning it against previously explored alternate reality terminology.
