...
Cross reality is the ubiquitous mixed reality situation that arises from the fusion of real-world sensor/actuator infrastructure with virtual environments, such that augmented reality and augmented virtuality manifest simultaneously and facilitate synchronous bidirectional exchange of media and control information between real and virtual environments. Sensors collect and tunnel dense real-world data into virtual environments where they are interpreted and displayed to dispersed users, whilst interaction of virtual participants simultaneously incarnates into the real world through a plenitude of diverse displays and actuators~\cite{Paradiso2009}.

The principle features that distinguish cross reality from the other alternate realities covered in section \ref{summaryofalternaterealitydefinitions} are;
\begin{enumerate}
...
One motivation behind this early Cross Reality work was what Lifton dubbed `the vacancy problem';
\begin{quote}
...
\subsection{Position}
Lifton's use of alternate reality terminology~\cite{Lifton2007a} does not reach the conclusion that mixed reality is a broad term that encompasses both augmented reality \& augmented virtuality $-$ in fact, he doesn't mention augmented virtuality even though his Cross Reality systems arguably cause it to manifest. The diagram that he presents (figure \ref{original_lifton_axis.png}) \& alludes to Milgram's continua places mixed reality as a separate classification of alternate reality between augmented reality \& virtual reality, even though his discussion of mixed reality hints that it logically encompasses augmented reality. Figure \ref{modified_lifton_axis.png} shows Lifton's diagram updated to show the definitions adopted in section \ref{summaryofalternaterealitydefinitions}.
