...
Lifton does however explain that while such a taxonomy can be successfully applied to most alternate reality efforts, it does not well address those that feature two complete realities, one real \& one virtual, which is one of the defining \& distinguishing characteristics of a XR system.
...
\textbf{***Use Illustrator version of Lifton thesis p38 here as well?}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{The two environments that comprise a XR system, plus the bidirectional information flow between them. \textbf{***Illustrator version of Lifton's diagram from his thesis p38}}
