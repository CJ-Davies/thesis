...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.6\textwidth]{focus-locus-sensus-with-virtuality-continuum.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{Want_virtuality_matrix_original.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{Want_virtuality_matrix_modified.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{Lifton_continuum_original.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{Lifton_continuum_modified.png}
