...
The concept of \textit{telepresence} is not included in this discussion, as it is not deemed representative of an \textit{alternate} reality but rather the ability for a user to experience a sense of presence at a real location remote to them~\cite{Sheridan1992a}. \textbf{***Check that this is a valid citation for this!}
