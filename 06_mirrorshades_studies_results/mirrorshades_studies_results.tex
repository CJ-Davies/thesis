...
stage 2.1 - control \& fading good, flashes bad but subconscious VR leads to more observation/understanding

stage 2.2 - the more subconscious VR the more observation/understanding, but too much makes the experience as a whole less enjoyable


informing PR in general

A 100\% RW view \& a 100\% VR view should be provided
A method of transitioning between the two at a user-controlled speed, with the ability to pause at any inbetween balance should be provided

A default view with \textless than 100\% RW should be provided, but should be toggleable \& not enforced
This \textless 100\% should not be too much \textless 100\% because going too far hampers the overall experience
