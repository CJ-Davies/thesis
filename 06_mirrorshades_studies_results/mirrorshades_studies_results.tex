...
\textbf{Scenario} & \textbf{Mean SP3} & \textbf{Mean INV2} \\
...
\begin{figure}[h]
	...
	\caption{Pitch \& yaw against time for participant 16 in 50/50 scenario, showing RW/VR transitions.}
...
\cmidrule(l){3-4} \cmidrule(l){5-6}
 ...
 & & \textbf{RW} & \textbf{VR} & \textbf{RW} & \textbf{VR} \\
...
\bottomrule
\end{tabularx}
\caption{Distribution of time spent in RW \& VR environments for all participants during 75/25 scenario.}
\label{floob}
\end{center}
\end{table}
...
\bottomrule
\end{tabularx}
\caption{Distribution of time spent in RW \& VR environments for all participants during 50/50 scenario.}
\label{floob}
\end{center}
\end{table}
