...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Path and positions within St Salvator's chapel that participants weere instructed to follow and attend to.}
		\label{chapel-path}
	\end{center}
\end{figure}
...
\begin{figure}
	...
	\caption{Pitch and yaw against time for participant 1 in traditional VR and PR scenarios.}
...
\begin{figure}
	...
	\caption{Pitch and yaw against time for participant 4 in traditional VR and PR scenarios.}
...
\begin{figure}
	...
	\caption{Pitch and yaw against time for participant 6 in traditional VR and PR scenarios.}
