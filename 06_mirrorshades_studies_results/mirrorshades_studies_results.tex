...
For all participants there was substantially more yaw change than pitch change, in both traditional \& PR scenarios. Can't really compare between traditional \& PR, however for what we do have of traditional they exhibit this more yaw than pitch relationship. This is the same as for stage 1.
...
***plots of pitch against yaw showing this for traditional \& both 1-3 \& 1-4

***standard deviation tables for pitch \& yaw

%=====================

\subsubsection{Comparing RW \& VR periods within PR scenarios}

For five out of seven participants, yaw change was greater when looking at virtual then looking at real for both 1-3 \& 1-4. Some quite substantially so. Difference between yaw change in real \& virtual greater in 1-4 than in 1-33, though this could be familiarity.
...
four of seven participants spent mroe time in real than virtual in both 1-3 \& 1-4
