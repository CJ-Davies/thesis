...
As can be seen in figure \ref{3_pitch_yaw.png} this relationship is even more prevalent in the data from participant 3, while the data from participant 5 in figure \ref{5_pitch_yaw.png} show the relationship to a lesser extent.
...
\textbf{***this relationship is confirmed by statistics}

%=====================

Comparing between RW \& VR periods of PR scenario

For several participants there was notably more head movement when they were perceiving virtual than when they were perceiving real
...
Substantially more yaw change than pitch change, in both traditional VR section \& both RW \& VR PR periods
